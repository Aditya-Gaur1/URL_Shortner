...
export const saveShortUrl = async (shortCode, originalUrl, userId) => {
  try {
    ...
    console.error("❌ Error while saving short URL:", error.message);
...
export const getShortUrlAndIncrementClicks = async (shortCode) => {
  try {
    ...
    console.error("❌ Error while getting short URL:", error.message);
...
// ======================================
// DELETE URL FOR A USER
// ======================================

export const deleteShortUrlById = async (urlId, userId) => {
  try {
    ...
    console.error("❌ Error while deleting short URL:", error.message);
